...
#define SYSEX_VARSPEED_SERVO  0x01
...
void sysexCallback(byte command, byte argc, byte *argv)
{
  ...
  switch (command) {
    case 0x01: // slow single servo command
      if(argc < 3) break;
      ...
      myservo1.write(servo_angle, move_speed, false);
      
      Firmata.sendSysex(command, argc, argv);
      break;
      
    /* slow multi servo command 0x02 [num of servo, [pins, angles, speeds], [pins, angles, speeds], ... ] */
    case 0x02:
      if(argc < 3) break;
      ...
      for(i=0; i<servo_count; i++){
        ...
        myservos[i].write(angle, vel, false);
      }
